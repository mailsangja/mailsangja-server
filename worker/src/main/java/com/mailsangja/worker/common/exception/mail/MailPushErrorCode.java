...
public enum MailPushErrorCode implements ErrorCode {
    ...
    INVALID_GMAIL_WATCH_RENEWAL_REQUEST(400, "MS-MAIL-INVALID-GMAIL-WATCH-RENEWAL-REQUEST", "Gmail watch 갱신 요청값이 올바르지 않습니다."),
    ...
    GMAIL_RATE_LIMIT_CONFIG_INVALID(500, "MS-MAIL-GMAIL-RATE-LIMIT-CONFIG-INVALID", "Gmail API Rate Limit 설정이 올바르지 않습니다."),
    GMAIL_RATE_LIMIT_UNAVAILABLE(503, "MS-MAIL-GMAIL-RATE-LIMIT-UNAVAILABLE", "Gmail API Rate Limit 확인에 실패했습니다."),
    GMAIL_RATE_LIMIT_EXCEEDED(429, "MS-MAIL-GMAIL-RATE-LIMIT-EXCEEDED", "Gmail API Rate Limit을 초과했습니다."),
