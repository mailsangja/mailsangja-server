...
public enum MailAccountErrorCode implements ErrorCode {
    ...
    MAIL_ACCOUNT_REAUTHORIZATION_NOT_REQUIRED(400, "MS-MAIL-ACCOUNT-REAUTHORIZATION-NOT-REQUIRED", "재연동이 필요한 메일 계정이 아닙니다."),
    MAIL_ACCOUNT_REAUTHORIZATION_EMAIL_MISMATCH(400, "MS-MAIL-ACCOUNT-REAUTHORIZATION-EMAIL-MISMATCH", "재연동하려는 Google 계정이 기존 메일 계정과 일치하지 않습니다."),
    ...
    MAIL_ACCOUNT_INACTIVE(400, "MS-MAIL-ACCOUNT-INACTIVE", "비활성화된 메일 계정입니다."),
